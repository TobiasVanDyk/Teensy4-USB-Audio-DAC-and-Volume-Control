...
Although it was tested with a Teensy 4.0 at 16bit/44.1kHz for both the PCM5102 and ES9023 Audio DACs, a changes to the Audio libraries core should enable higer (44.1, 48, 88.2 96 kHz), sampling rates and/or improve the resolution - see:
1. [**Highres IO now possible**](https://forum.pjrc.com/threads/40568-Floating-Point-Audio-Library-Extension?p=306027&viewfull=1#post306027) 
2. [**USB-Audio-samplerates-added**](https://forum.pjrc.com/threads/67749-USB-Audio-samplerates-added)
...
4. [**Discussion about a simple way to change the sample-rate**](https://forum.pjrc.com/threads/38753-Discussion-about-a-simple-way-to-change-the-sample-rate/page4)
5. [**The official view on this topic**](https://www.pjrc.com/teensy/td_libs_AudioRoadmap.html)
...
For examples of changing the usb descriptors refer to [**Use Teensy as Midi and USB Keyboard controller at the same time**](https://forum.pjrc.com/threads/55691-Use-Teensy-as-Midi-and-USB-Keyboard-controller-at-the-same-time), and [**How to add a new interface to support RawHID + Keyboard**](https://forum.pjrc.com/threads/69500-2022-How-to-add-a-new-interface-to-support-RawHID-Keyboard), [**Using I2S causes Teensy 4.1 to not boot**](https://forum.pjrc.com/threads/70135-Using-I2S-causes-Teensy-4-1-to-not-boot-no-setup()-no-serial-no-debug),
[**48kHz 8i80 USB Audio**](https://forum.pjrc.com/threads/60557-48kHz-8i80-USB-Audio), [**Teensy 4.1 USB 4CH IN - 2 CH OUT Sync issue**](https://forum.pjrc.com/threads/68747-Teensy-4-1-USB-4CH-IN-2-CH-OUT-Sync-issue), and [**Dual SerialUSB and MIDI config possible**](https://forum.pjrc.com/threads/66330-Dual-SerialUSB-and-MIDI-config-possible). 
